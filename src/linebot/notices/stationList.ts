...
詳しくはぜひ動画を見てもらいたい。なお海外でバズったそうで再生回数2億回である。`,
    references: [
      {
...
バナナの叩き売り発祥の地はここ北九州市なのだ。流石に作中のように突然値上げ、徴収されることはないと思う...多分`,
    references: [
      {
...
ラーメンだるまは北九州市内の学生がこよなく愛することで有名な二郎系ラーメン。その本店である戸畑店はここ九州工大前駅が最寄りだ。ここに限らず、全マシマシを頼むのは修羅と心得ることが大切。`,
    references: [
      {
...
北九州市立美術館では映画「デスノート」や「図書館戦争」の撮影が行われたのみならず、北九州の街全体で映画撮影を行うこともあり、特撮の映画の舞台になったこともある。`,
    references: [
      {
        url: 'https://kmma.jp/',
        about: '北九州市立美術館',
  ...
  },
  {
    ...
    keyScenario: '枝光へ向かう',
    text: `
かつてはスペースワールドの最寄り駅だった、1908年からある古い駅。
...
安い上にシンプルにうまいということで2桁の量を軽く買って家族で食べる人もいるそうだ。
`,
    references: [
      {
...
花火のモデルはくきのうみ花火。
ライトアップはもちろん行われているが、シナリオのような珍事は起きることはないと思う。
`,
    references: [
      {
        url: 'https://ja.wikipedia.org/wiki/藤ノ木駅',
